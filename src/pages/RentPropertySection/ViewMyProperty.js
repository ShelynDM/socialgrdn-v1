...
export default function ViewMyProperty() {
    ...
    const getAllImages = () => {
        if (!property) return [];
        return [property.primaryImage, ...(property.otherImages || [])].filter(Boolean);
    };
                ...
                <section className="space-y-2">
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <p className="text-sm text-gray-700">{property.dimension || 'N/A'}</p>
                        </div>
                        <div>
                            <p className="text-sm font-semibold">Soil Type</p>
                            <p className="text-sm text-gray-700">{property.soil_type || 'N/A'}</p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-700">{property.crops?.join(', ') || 'None listed'}</p>
                    </div>
                </section>
