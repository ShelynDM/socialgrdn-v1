...
export default function Profile() {
    return (
        <div className='bg-main-background relative'>
            ...
            <BackButton/>
            <FaUserCircle className="text-green-500 text-9xl w-full sm:w-3/4 md:w-2/3 lg:w-1/2 xl:w-1/3 mt-6" />
            ...
            <div className="px-8 mx-auto w-full sm:w-3/4 md:w-2/3 lg:w-1/2 xl:w-1/3">
                <button className="w-full  py-3 text-lg font-bold text-white bg-green-500 rounded hover:bg-green-600"> Edit</button>
            </div>
            <div className="flex ml-10 items-center space-x-4 p-2 mt-8 mb-2">
                <GrMapLocation className="text-1" />
                <h1 className="text-xl font-semibold">I am a landowner</h1>
